...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Employee employee3 = new Employee(3,"Mr","Matt","Jones","Trainer","Tech Education");
        Employee employee4 = new Employee(4, "Mrs", "Jenny", "Green", "Manager", "Tech Education");
        ...
        Employee removedEmployee = employeesList.remove(0);
